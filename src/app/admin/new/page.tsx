          ...
          <div className="xl:col-span-2 space-y-5">
            ...
            <div className="bg-white rounded-2xl border border-rose-100 shadow-sm p-6">
              ...
              {showSlug && (
                <div className="flex items-center mt-3 pt-3 border-t border-rose-50 gap-2">
                  ...
                  >
                    {showSlug ? <EyeOff size={13} /> : <Eye size={13} />}
                  </button>
                </div>
              )}
            </div>
            ...
            <div className="bg-white rounded-2xl border border-rose-100 shadow-sm overflow-hidden">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-rose-50 border border-rose-100" style={{ color: "#b76e79" }}>
                    Recommended
                  </span>
                </div>
                {seoOpen ? <ChevronUp size={16} className="text-zinc-400" /> : <ChevronDown size={16} className="text-zinc-400" />}
              </button>
                ...
                <div className="px-6 pb-6 space-y-4 border-t border-rose-50">
                  ...
                  <div className="p-4 bg-rose-50/50 rounded-xl border border-rose-100">
                    ...
                    <p className="text-xs text-zinc-500 mb-2">
                      Add these links in your content to boost SEO:
                    </p>
                    {[
            ...
            <div className="bg-white rounded-2xl border border-rose-100 shadow-sm overflow-hidden">
              ...
              >
                ...
                {schemaOpen ? <ChevronUp size={16} className="text-zinc-400" /> : <ChevronDown size={16} className="text-zinc-400" />}
              </button>
              {schemaOpen && (
