...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://chauffeurdubai.ae/blog" },
}
    ...
    <div className="w-full bg-white overflow-x-hidden">
      ...
      {posts.length === 0 ? (
        ...
        <>
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        <span
                          className={`text-[10px] font-medium px-2.5 py-1 rounded-full border ${
                            categoryColors[featured.category] ?? categoryColors["General"]
                          }`}
                        >
                          {featured.category}
                        </span>
                      ...
                      <div className="flex items-center justify-between pt-5 border-t border-rose-100">
                        <div className="flex items-center gap-4 text-[11px] text-zinc-400">
                          <span className="flex items-center gap-1.5">
                            ...
                            {new Date(featured.date).toLocaleDateString("en-AE", {
                              day: "numeric",
                              month: "long",
                              year: "numeric",
                            })}
          ...
          {rest.length > 0 && (
            <section
              className="px-5 md:px-12 lg:px-20 py-14 border-t border-rose-100"
      ...
      {/* BOTTOM CTA */}
      <section
        className="py-16 px-5 text-center border-t border-rose-100"
        style={{ background: roseGold }}
      >
        ...
        <p className="text-white/60 text-xs mb-6">
          Available 24/7 across Dubai, Abu Dhabi, and Sharjah
        </p>
        <a
