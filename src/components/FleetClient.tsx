                  ...
                  <div className="absolute top-full right-0 mt-2 w-72 bg-white rounded-2xl border border-rose-100 shadow-2xl overflow-hidden z-50">
                    <button
                      ...
                      className={`w-full text-left px-4 py-3 text-sm flex items-center justify-between gap-2 transition-all ${
                        !activeClass ? "font-bold text-white" : "font-medium text-zinc-600 hover:bg-rose-50"
                      }`}
                    ...
                    {availableClasses.map((cls, i) => (
                      ...
                      >
                        <span className="flex items-center gap-2">
                          ...
                          <span className="text-xs opacity-70">({grouped[cls].length})</span>
                        </span>
                  ...
                  >
                    <div className="relative h-52 overflow-hidden">
                      ...
                      <div className="absolute bottom-3 left-3">
                        ...
                        <p className="text-white font-bold text-lg leading-tight">{vehicle.transferPrice}</p>
                      </div>
                    </div>

                    <div className="p-5 flex flex-col flex-1">
                      <h3 className="font-bold text-zinc-900 text-base mb-1">{vehicle.name}</h3>
                      <p className="text-zinc-400 text-xs leading-relaxed mb-4 line-clamp-2">{vehicle.desc}</p>
                      ...
                      <div className="rounded-xl p-3 mb-4 grid grid-cols-3 gap-2 text-center text-xs" style={{ background: roseGoldGradientSubtle }}>
                        ...
                        <div className="border-x border-rose-100">
                          ...
                          <p className="font-bold text-zinc-800 mt-0.5">{vehicle.price5hr.replace(" / 5 Hr", "")}</p>
                        </div>
                        <div>
                          <p className="text-zinc-400 text-[10px] uppercase tracking-wider">10 Hours</p>
                          <p className="font-bold text-zinc-800 mt-0.5">{vehicle.price10hr.replace(" / 10 Hr", "")}</p>
                        </div>
                      </div>
